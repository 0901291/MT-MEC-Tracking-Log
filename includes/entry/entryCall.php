        ...
        switch ($_POST["method"]) {
            ...
            case "edit":
                if (is_numeric($_POST['id'])) {
                    $entry -> id = $_POST['id'];
                    $entry -> title = (isset($_POST['title']) ? $_POST['title'] : "");
                    $entry -> date = (isset($_POST['date']) ? $_POST['date'] : "");
                    $entry -> description = (isset($_POST['description']) ? $_POST['description'] : "");
                    $entry -> imgURL = (isset($_POST['imgURL']) ? $_POST['imgURL'] : "");
                    $entry -> lng = (isset($_POST['lng']) ? $_POST['lng'] : "");
                    $entry -> lat = (isset($_POST['lat']) ? $_POST['lat'] : "");
                    $entry -> companies = (isset($_POST['companies']) ? $_POST['companies'] : null);
                    $entry -> dataTypes = (isset($_POST['dataTypes']) ? $_POST['dataTypes'] : null);
                    $entry -> category = (isset($_POST['category']) ? $_POST['category'] : null);
